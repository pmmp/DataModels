...
class PocketMineYml_Player97b5e4ef01343ffe22437e1e01a6a2f9 implements JSONModelInterface
{
    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : bool
            {
                ...
                /**
                 * Set the value of save-player-data.
                 *
                 * @param bool $savePlayerData Whether to save player data.
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setSavePlayerData(
                    bool $savePlayerData
                ): self {
                    if ($this->savePlayerData === $savePlayerData) {
                        return $this;
                    }

                    $value = $modelData['save-player-data'] = $savePlayerData;

                    

                    

                    $value = $this->validateSavePlayerData($value, $modelData);

                    

                    $this->savePlayerData = $value;
                    $this->_rawModelDataInput['save-player-data'] = $savePlayerData;
  ...
  1 => 'bool',
                ...
                : bool
            {
                ...
                /**
                 * Set the value of verify-xuid.
                 *
                 * @param bool $verifyXuid Whether to check that joining players' XUIDs match the last recorded XUID (prevents impersonation attacks).
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setVerifyXuid(
                    bool $verifyXuid
                ): self {
                    if ($this->verifyXuid === $verifyXuid) {
                        return $this;
                    }

                    $value = $modelData['verify-xuid'] = $verifyXuid;

                    

                    

                    $value = $this->validateVerifyXuid($value, $modelData);

                    

                    $this->verifyXuid = $value;
                    $this->_rawModelDataInput['verify-xuid'] = $verifyXuid;
