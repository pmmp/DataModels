    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : bool
            {
                ...
                /**
                 * Set the value of warn-console.
                 *
                 * @param bool $warnConsole Whether to log a message on the console if a new version is available.
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setWarnConsole(
                    bool $warnConsole
                ): self {
                    if ($this->warnConsole === $warnConsole) {
                        return $this;
                    }

                    $value = $modelData['warn-console'] = $warnConsole;

                    

                    

                    $value = $this->validateWarnConsole($value, $modelData);

                    

                    $this->warnConsole = $value;
                    $this->_rawModelDataInput['warn-console'] = $warnConsole;
