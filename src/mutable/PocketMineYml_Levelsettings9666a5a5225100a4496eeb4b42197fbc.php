    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : string
            {
                ...
                /**
                 * Set the value of default-format.
                 *
                 * @param string $defaultFormat Name of the format to use for generating new worlds by default.
                 *
                 * @throws ValidationException
                 *
                 * @return self
                ...
                public function setDefaultFormat(
                    ...
                    if ($this->defaultFormat === $defaultFormat) {
                        return $this;
                    }

                    $value = $modelData['default-format'] = $defaultFormat;

                    

                    

                    $value = $this->validateDefaultFormat($value, $modelData);

                    

                    $this->defaultFormat = $value;
                    $this->_rawModelDataInput['default-format'] = $defaultFormat;
