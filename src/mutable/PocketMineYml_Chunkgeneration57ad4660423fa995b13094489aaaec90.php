    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : int
            {
                ...
                /**
                 * Set the value of population-queue-size.
                 *
                 * @param int $populationQueueSize Maximum number of chunks to generate/populate concurrently.
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setPopulationQueueSize(
                    int $populationQueueSize
                ): self {
                    if ($this->populationQueueSize === $populationQueueSize) {
                        return $this;
                    }

                    $value = $modelData['population-queue-size'] = $populationQueueSize;

                    

                    

                    $value = $this->validatePopulationQueueSize($value, $modelData);

                    

                    $this->populationQueueSize = $value;
                    $this->_rawModelDataInput['population-queue-size'] = $populationQueueSize;
