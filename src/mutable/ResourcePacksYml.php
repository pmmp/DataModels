...
class ResourcePacksYml implements JSONModelInterface
{
    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : bool
            {
                ...
                /**
                 * Set the value of force_resources.
                 *
                 * @param bool $forceResources Whether players must use the listed resource packs to join the server
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setForceResources(
                    bool $forceResources
                ): self {
                    if ($this->forceResources === $forceResources) {
                        return $this;
                    }

                    $value = $modelData['force_resources'] = $forceResources;

                    

                    

                    $value = $this->validateForceResources($value, $modelData);

                    

                    $this->forceResources = $value;
                    $this->_rawModelDataInput['force_resources'] = $forceResources;
  ...
  1 => 'bool',
                ...
                
            {
                ...
                /**
                 * Set the value of resource_stack.
                 *
                 * @param string[]|null $resourceStack
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setResourceStack(
                     $resourceStack
                ): self {
                    if ($this->resourceStack === $resourceStack) {
                        return $this;
                    }

                    $value = $modelData['resource_stack'] = $resourceStack;

                    

                    

                    $value = $this->validateResourceStack($value, $modelData);

                    

                    $this->resourceStack = $value;
                    $this->_rawModelDataInput['resource_stack'] = $resourceStack;
