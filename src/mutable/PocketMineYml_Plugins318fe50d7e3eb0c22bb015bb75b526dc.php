    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : ?bool
            {
                ...
                /**
                 * Set the value of legacy-data-dir.
                 *
                 * @param bool $legacyDataDir Whether to store plugin data in plugins directory instead of plugin_data.
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setLegacyDataDir(
                    bool $legacyDataDir
                ): self {
                    if ($this->legacyDataDir === $legacyDataDir) {
                        return $this;
                    }

                    $value = $modelData['legacy-data-dir'] = $legacyDataDir;

                    

                    

                    $value = $this->validateLegacyDataDir($value, $modelData);

                    

                    $this->legacyDataDir = $value;
                    $this->_rawModelDataInput['legacy-data-dir'] = $legacyDataDir;
