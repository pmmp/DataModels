    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                ...
                : bool
            {
                ...
                /**
                 * Set the value of title-tick.
                 *
                 * @param bool $titleTick Whether to enable status reporting on the window title bar.
                 *
                 * @throws ValidationException
                 *
                 * @return self
                 */
                public function setTitleTick(
                    bool $titleTick
                ): self {
                    if ($this->titleTick === $titleTick) {
                        return $this;
                    }

                    $value = $modelData['title-tick'] = $titleTick;

                    

                    

                    $value = $this->validateTitleTick($value, $modelData);

                    

                    $this->titleTick = $value;
                    $this->_rawModelDataInput['title-tick'] = $titleTick;
